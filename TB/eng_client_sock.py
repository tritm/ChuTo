...
def wait_for_request_from_mgr():
    # This function will wait until there is data sending from HM and 
    #receive 1024 byte from the beginning then move to the next line
    data =  s.recv(1024)  
